...
I remembered from the in class activity to use the filter function and apply it to the whole data set. After setting that up I filtered the for impeachment column because that is the variable of interest.
